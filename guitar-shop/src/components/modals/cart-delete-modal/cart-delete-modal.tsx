function СartDeleteModal(): JSX.Element {
  return (
      ...
      <div className="modal is-active">
        <div className="modal__wrapper">
          ...
          <div className="modal__content">
            ...
            <div className="modal__info"><img className="modal__img" src="img/content/catalog-product-1.png" srcSet="img/content/catalog-product-1@2x.png 2x" width="67" height="137" alt="Честер bass"/>
...
export default СartDeleteModal;
